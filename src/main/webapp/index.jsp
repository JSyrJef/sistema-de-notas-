                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    ...
                                    <img src="imagenes/graduado.png" class="img-fluid" alt="responsive-image">
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="listarEstu.jsp">Acceder</a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body"><h1 class="display-4">Notas</h1></div>
                                    <img src="imagenes/calificacion.png" class="img-fluid" alt="responsive-image">
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    ...
                                    <img src="imagenes/educacion.png" class="img-fluid" alt="responsive-image">
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">Acceder</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body"><h1 class="display-4">Grados</h1></div>
                                    <img src="imagenes/promocion.png" class="img-fluid" alt="responsive-image">
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">Acceder</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
