...
<html lang="en">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Editar Calificacion</li>
                        </ol>
                        <div class="card m-auto" style="width: 50rem;">
                          ...
                          //Conexion BD
                			...
                			ps=con.prepareStatement("select id_registro,nota from registro_notas where id_registro="+id);
                			rs=ps.executeQuery();
                            //form del alumno identificado
                            
                            while(rs.next()){
                            %>
                            <form class="register-form" action="update_nota" method="post" style="padding: 10px;">
                            	<div class="form-group">
                                  <label for="IdR">ID</label>
                                  <input type="number" class="form-control" id="IdR" name="IdR" value="<%= rs.getInt("id_registro")%>" readonly="readonly">
                                </div>
                                <div class="form-group">
                                  <label for="ModNota">Nota</label>
                                 <input  type="number" min="0" max="10" step="0.01" class="form-control" id="ModNota" name="ModNota" value="<%= rs.getFloat("nota") %>">
                                </div>
	...
	var status = document.getElementById("status").value;
	  if(status == "success"){
	  		swal("Proceso Exitoso","La nota se actualizo correctamente","success");
	  }
	</script>
    </body>
</html>