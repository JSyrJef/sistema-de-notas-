...
<html lang="en">
                      ...
                      <div class="card" style="margin: auto 70px;" >
                        <div class="card-header" style="background-color: white;">
                            <form class="form-inline pt-2">
                                ...
                                <input class="form-control mb-3 mr-sm-4" type="text" id="inline-form-input-grado" onkeyup="myFunction()" placeholder="Buscar por Grado" style="width: auto;">
                                </div>
                                ...
                                <input class="form-control mb-3 mr-sm-4" type="text" id="inline-form-input-seccion" onkeyup="myFunction2()" placeholder="Buscar por Seccion"  style="width: auto;">
                                </div>
                                    ...
                                    <td>
                                        <div class="btn-group dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                              <a href="ElimEstu.jsp?idAlumno=<%= rs.getInt(1)%>" class="dropdown-item"><i class='fas fa-trash-alt'></i> Eliminar Alumno</a>
                                              <div class="dropdown-divider"></div>
                                              <a href="editEstu.jsp?idAlumno=<%= rs.getInt(1)%>" class="dropdown-item"><i class='fas fa-tools'></i> Modificar Alumno</a>
                                              <div class="dropdown-divider"></div>
                                              <a href="CaliList.jsp?idAlumno=<%= rs.getInt(1)%>" class="dropdown-item"><i class='fas fa-pen-alt'></i> Calificaciones</a>
                                            </div>
                                          </div>
                                      </td>
                                  </tr>
    ...
    <!-- Main filter input search-->
    <script>
	function myFunction() {
	// Declare variables
  	var input, filter, table, tr, td, i, txtValue;
  	input = document.getElementById("inline-form-input-grado");
	...
	function myFunction2() {
		// Declare variables
	  	var input, filter, table, tr, td, i, txtValue;
	  	input = document.getElementById("inline-form-input-seccion");
	  	filter = input.value.toUpperCase();
	  	table = document.getElementById("mytable");
	  	tr = table.getElementsByTagName("tr");
