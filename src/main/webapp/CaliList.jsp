    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
				  ...
				  <tbody>
				    <tr>
				      <td><%= rs.getString("materia") %></td>
                           ...
                           <%
                        //Conexion BD
            			String sql22 = "SELECT evaluacion,materia,nota  from registro_notas INNER JOIN evaluaciones on registro_notas.id_evaluacion = evaluaciones.id_evaluacion INNER JOIN materia on registro_notas.id_materia = materia.id_materia where evaluacion='lab1' AND id_alumno="+id;
				...
				<%
                        //Conexion BD
            			String sql3 = "SELECT evaluacion,materia,nota from registro_notas INNER JOIN evaluaciones on registro_notas.id_evaluacion = evaluaciones.id_evaluacion INNER JOIN materia on registro_notas.id_materia = materia.id_materia where evaluacion='lab2' AND id_alumno="+id;
				...
				<%
                        //Conexion BD
            			String sql4 = "SELECT evaluacion,materia,nota from registro_notas INNER JOIN evaluaciones on registro_notas.id_evaluacion = evaluaciones.id_evaluacion INNER JOIN materia on registro_notas.id_materia = materia.id_materia where evaluacion='lab3' AND id_alumno="+id;
                ...
                <%
                        //Conexion BD
            			String sql5 = "SELECT evaluacion,materia,nota from registro_notas INNER JOIN evaluaciones on registro_notas.id_evaluacion = evaluaciones.id_evaluacion INNER JOIN materia on registro_notas.id_materia = materia.id_materia where evaluacion='examU1' AND id_alumno="+id;
